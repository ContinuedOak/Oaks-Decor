...
public class CrimsonBlackstoneBricksFeature extends OreFeature {
	public static CrimsonBlackstoneBricksFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new CrimsonBlackstoneBricksFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("oaks_decor:crimson_blackstone_bricks", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.POLISHED_BLACKSTONE_BRICKS.defaultBlockState()),
						OaksDecorModBlocks.CRIMSON_BLACKSTONE_BRICKS.get().defaultBlockState())), 32));
		PLACED_FEATURE = PlacementUtils.register("oaks_decor:crimson_blackstone_bricks", CONFIGURED_FEATURE,
	...
	public CrimsonBlackstoneBricksFeature() {
