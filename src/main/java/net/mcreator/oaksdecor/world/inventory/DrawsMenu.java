...
public class DrawsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DrawsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OaksDecorModMenus.DRAWS.get(), id);
