...
public class PaperRightClickProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.isShiftKeyDown()
				&& Items.PAPER == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()) {
			if (Blocks.AIR == (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock()) {
				world.setBlock(new BlockPos(x, y + 1, z), OaksDecorModBlocks.PAPER.get().defaultBlockState(), 3);
				if (!(new Object() {
				...
				&& Items.PAPER == (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem()) {
			if (Blocks.AIR == (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock()) {
				world.setBlock(new BlockPos(x, y + 1, z), OaksDecorModBlocks.PAPER.get().defaultBlockState(), 3);
				if (!(new Object() {
					public boolean checkGamemode(Entity _ent) {
