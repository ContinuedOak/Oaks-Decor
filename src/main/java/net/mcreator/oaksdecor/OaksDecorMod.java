...
@Mod("oaks_decor")
public class OaksDecorMod {
	public static final Logger LOGGER = LogManager.getLogger(OaksDecorMod.class);
	...
	public OaksDecorMod() {
		...
		OaksDecorModSounds.REGISTRY.register(bus);
		OaksDecorModBlocks.REGISTRY.register(bus);
		OaksDecorModItems.REGISTRY.register(bus);
		OaksDecorModEntities.REGISTRY.register(bus);
		OaksDecorModBlockEntities.REGISTRY.register(bus);
		OaksDecorModFeatures.REGISTRY.register(bus);

		OaksDecorModMenus.REGISTRY.register(bus);
