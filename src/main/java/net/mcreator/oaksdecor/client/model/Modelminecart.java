...
public class Modelminecart<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("oaks_decor", "modelminecart"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition front2 = front.addOrReplaceChild("front2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -10.0F, 8.0F, 16.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -9.0F, 0.0F, 3.1416F, 0.0F));
		PartDefinition back2 = front.addOrReplaceChild("back2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -10.0F, 8.0F, 16.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 1.0F, -9.0F));
		PartDefinition right2 = front.addOrReplaceChild("right2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -10.0F, 6.0F, 16.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -9.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition left2 = front.addOrReplaceChild("left2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -10.0F, 6.0F, 16.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -9.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition base = front.addOrReplaceChild("base",
				CubeListBuilder.create().texOffs(0, 10).addBox(-10.0F, -8.0F, 0.0F, 20.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)),
